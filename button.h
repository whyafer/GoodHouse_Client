...
public:
    Button(QString text, int x, int y, int w, int h, int s = 14, int tpye = 0, bool vari = true,
           int r = LightSkyBlue.red(), int g = LightSkyBlue.green(), int b = LightSkyBlue.blue(), int a = 255,
           int lr = RoyalBlue.red(), int lg = RoyalBlue.green(), int lb = RoyalBlue.blue(), bool isEnglish = false,
           bool Random = false);
